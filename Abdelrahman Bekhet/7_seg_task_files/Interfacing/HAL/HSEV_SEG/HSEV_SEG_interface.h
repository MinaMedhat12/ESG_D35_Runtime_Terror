...
/**
 * @brief This Function Makes 7_Segment Work as a counter (Should this be in app layer?)
 * time in msec, smallest time is 20 msec
 * 
 * @param au8_start 
 * @param au8_end 
 * @param au8_Count_Periodoc_Time
 */

void hsev_seg_displayCounter(u8_t au8_start,u8_t au8_end,unsigned int a32_Count_Periodic_Time);
