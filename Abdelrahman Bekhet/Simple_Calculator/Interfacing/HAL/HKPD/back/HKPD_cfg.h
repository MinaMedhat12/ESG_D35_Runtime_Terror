...
/* Switching ROW3 and COL3 Pins due to existence of LED2 on Pin 3
    Pins connected to LEDs must be initialized as outputs because using them 
    as inputs form a voltage divider on the sesnsing pin*/ 
