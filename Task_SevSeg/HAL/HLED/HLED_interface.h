...
/**
 * @brief This function is responsible for setting the specific LED pin to output
 * 
 * @param au8_ledNumber 
 */
...
/**
 * @brief This function is responsible for setting the specific LED status to ON
 * 
 * @param au8_ledNumber 
 */
...
/**
 * @brief This function is responsible for setting the specific LED status to OFF
 * 
 * @param au8_ledNumber 
 */
...
/**
 * @brief This function is responsible for toggling the specific LED status (ON -> OFF / OFF -> ON)
 * 
 * @param au8_ledNumber 
 */
